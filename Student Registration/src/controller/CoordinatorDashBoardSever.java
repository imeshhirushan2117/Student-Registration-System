...
public class CoordinatorDashBoardSever {
    ...
    public ObservableList<StudentTm> getStudentData() throws SQLException, ClassNotFoundException {
        ...
        PreparedStatement stm = DbConnection.getInstance().getConnection().prepareStatement("SELECT COUNT(Student_Id), b. Batch_Name, c.Course_Name from batch b, course c, student s WHERE  c.Course_Id=s.Course_Id AND b.Batch_Id =s.Batch_Id GROUP BY  Batch_Name;");
